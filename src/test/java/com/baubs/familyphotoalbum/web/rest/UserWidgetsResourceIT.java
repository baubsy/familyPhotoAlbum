...
import com.baubs.familyphotoalbum.repository.UserWidgetsRepository;
...
class UserWidgetsResourceIT {
    ...
    void createUserWidgets() throws Exception {
        ...
        restUserWidgetsMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(userWidgets)))
    ...
    void putWithMissingIdPathParamUserWidgets() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restUserWidgetsMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(userWidgets)))
    ...
    void patchWithMissingIdPathParamUserWidgets() throws Exception {
        ...
        restUserWidgetsMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(userWidgets))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteUserWidgets() throws Exception {
        ...
        restUserWidgetsMockMvc
            .perform(delete(ENTITY_API_URL_ID, userWidgets.getId()).accept(MediaType.APPLICATION_JSON))
