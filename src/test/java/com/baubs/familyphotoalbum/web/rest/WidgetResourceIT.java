...
import com.baubs.familyphotoalbum.repository.WidgetRepository;
...
class WidgetResourceIT {
    ...
    void createWidget() throws Exception {
        ...
        // Create the Widget
        restWidgetMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(widget)))
    ...
    void putWithMissingIdPathParamWidget() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restWidgetMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(widget)))
    ...
    void patchWithMissingIdPathParamWidget() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restWidgetMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(widget)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteWidget() throws Exception {
        ...
        // Delete the widget
        restWidgetMockMvc
            .perform(delete(ENTITY_API_URL_ID, widget.getId()).accept(MediaType.APPLICATION_JSON))
