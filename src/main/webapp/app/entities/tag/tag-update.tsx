  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="familyPhotoAlbumApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="tag-name" name="name" data-cy="name" type="text" />
