  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="familyPhotoAlbumApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="album-name" name="name" data-cy="name" type="text" />
              <ValidatedField label="Description" id="album-description" name="description" data-cy="description" type="text" />
